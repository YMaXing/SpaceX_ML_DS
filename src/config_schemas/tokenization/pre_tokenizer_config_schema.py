...
def setup_config() -> None:
    ...
    cs.store(name="bert_pre_tokenizer_schema", node=BertPreTokenizerConfig, group="tokenizer/pre_tokenizer")

    cs.store(name="byte_level_pre_tokenizer_schema", node=ByteLevelPreTokenizerConfig, group="tokenizer/pre_tokenizer")
    ...
    cs.store(name="digits_pre_tokenizer_schema", node=DigitsPreTokenizerConfig, group="tokenizer/pre_tokenizer")

    cs.store(name="metaspace_pre_tokenizer_schema", node=MetaspacePreTokenizerConfig, group="tokenizer/pre_tokenizer")

    cs.store(
        name="punctuation_pre_tokenizer_schema", node=PunctuationPreTokenizerConfig, group="tokenizer/pre_tokenizer"
    )

    cs.store(name="sequence_pre_tokenizer_schema", node=SequencePreTokenizerConfig, group="tokenizer/pre_tokenizer")

    cs.store(name="split_pre_tokenizer_schema", node=SplitPreTokenizerConfig, group="tokenizer/pre_tokenizer")
    ...
    cs.store(name="whitespace_pre_tokenizer_schema", node=WhitespacePreTokenizerConfig, group="tokenizer/pre_tokenizer")
