...
def setup_config() -> None:
    ...
    cs.store(name="bert_post_processor_schema", node=BertPostProcessorConfig, group="tokenizer/post_processor")

    cs.store(name="post_processor_schema", node=PostProcessorConfig, group="tokenizer/post_processor")

    cs.store(
        name="byte_level_post_processor_schema", node=ByteLevelPostProcessorConfig, group="tokenizer/post_processor"
    )

    cs.store(name="roberta_post_processor_schema", node=RobertaPostProcessorConfig, group="tokenizer/post_processor")
