...
def setup_config() -> None:
    ...
    cs.store(name="bpe_model_schema", node=BPEModelConfig, group="tokenizer/model")

    cs.store(name="unigram_model_schema", node=UnigramModelConfig, group="tokenizer/model")

    cs.store(name="word_level_model_schema", node=WordLevelModelConfig, group="tokenizer/model")

    cs.store(name="word_piece_model_schema", node=WordPieceModelConfig, group="tokenizer/model")
