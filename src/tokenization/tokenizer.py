...
from tokenizers.processors import BertProcessing, RobertaProcessing, ByteLevelProcessing, TemplateProcessing
...
class HuggingFaceTokenizer(Base_Tokenizer):
    ...
    def save(self, tokenizer_save_dir: str) -> None:
        tokenizer = PreTrainedTokenizerFast(tokenizer_object=self.tokenizer, unk_token=self.unk_token, cls_token=self.cls_token, sep_token=self.sep_token, pad_token=self.pad_token, mask_token=self.mask_token) 
